      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span
              style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '22px', color: '#FAFAF8', fontStyle: 'italic', fontWeight: 400 }}
            >
              Mi Carrito
            </span>
            {totalItems > 0 && (
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px' }}>
          {items.length === 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: '12px' }}>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '20px', color: 'rgba(250,250,248,0.3)', fontStyle: 'italic' }}>
                El carrito está vacío
              </p>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '12px', color: 'rgba(250,250,248,0.2)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '9px', color: 'rgba(250,250,248,0.35)', letterSpacing: '0.18em', textTransform: 'uppercase' }}>
                        {item.house}
                      </p>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '6px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', border: '1px solid rgba(232,228,220,0.15)' }}>
                          ...
                          <span style={{ width: '32px', textAlign: 'center', fontFamily: "'DM Sans', sans-serif", fontSize: '13px', color: '#FAFAF8', borderLeft: '1px solid rgba(232,228,220,0.15)', borderRight: '1px solid rgba(232,228,220,0.15)', lineHeight: '28px' }}>
                            {item.quantity}
                          </span>
                          <button
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
